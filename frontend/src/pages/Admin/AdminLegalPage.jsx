                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            <h1 className="text-2xl md:text-3xl font-bold text-white">Legal Services Admin</h1>
                            <span className="hidden md:inline-block text-orange-100">Manage all legal services</span>
                        </div>
                        <div className="flex items-center space-x-4">
